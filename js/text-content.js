...
const translations = {
  ka: {
    ...
    "calc.receive_value": "მიიღეთ ღირებულების 145% თითოეულ გაცვლაზე",
    ...
    "faq.rate_answer":
      "პერიოდულობის მიხედვით იცვლება. დასაწყისისთვის კურსი არის 400 Plus = 1.45 ₾. კურსი შეგიძლია გადაამოწმოთ ჩვენს კალკულატორზე.",
  ...
  en: {
    ...
    "calc.receive_value": "Receive 145% of the value for each exchange",
    ...
    "faq.rate_answer":
      "It varies depending on the period. The starting rate is 400 Plus = 1.45 ₾. You can check the rate on our calculator.",
