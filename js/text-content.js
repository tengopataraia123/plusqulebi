...
const translations = {
  ka: {
    ...
    "calc.receive_value": "მიიღეთ ღირებულების 90% თითოეულ გაცვლაზე",
    ...
    "faq.rate_answer":
      "პერიოდულობის მიხედვით იცვლება. დასაწყისისთვის კურსი არის 400 Plus = 0.90 ₾. კურსი შეგიძლია გადაამოწმოთ ჩვენს კალკულატორზე.",
  ...
  en: {
    ...
    "calc.receive_value": "Receive 90% of the value for each exchange",
    ...
    "faq.rate_answer":
      "It varies depending on the period. The starting rate is 400 Plus = 0.90 ₾. You can check the rate on our calculator.",
